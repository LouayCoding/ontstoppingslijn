      ...
      <div className="mx-auto max-w-[1200px] px-6">
        ...
        >
          ...
          >
            ...
            <p className="text-xs font-semibold text-accent mb-2">{t("contactPage.phone")}</p>
            <p className="text-xl font-heading font-semibold group-hover:text-accent transition-colors">
              {PHONE_NUMBER}
            </p>
            <p className="text-sm text-muted mt-2">{t("contactPage.available")}</p>
          </motion.a>
          ...
          >
            ...
            <p className="text-xs font-semibold text-accent mb-2">{t("contactPage.email")}</p>
            <p className="text-xl font-heading font-semibold group-hover:text-accent transition-colors">
              {EMAIL}
            </p>
            <p className="text-sm text-muted mt-2">{t("contactPage.emailNote")}</p>
          </motion.a>
          ...
          >
            ...
            <p className="text-xs font-semibold text-accent mb-2">{t("contactPage.area")}</p>
            <p className="text-xl font-heading font-semibold">{t("contactPage.areaValue")}</p>
            <p className="text-sm text-muted mt-2">{t("contactPage.areaNote")}</p>
          </motion.div>
        </motion.div>
      </div>
    </section>
